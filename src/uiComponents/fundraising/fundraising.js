...
class Fundraising extends Component {
  ...
  render() {
    ...
    let modal = (
      <div className="modal">
        <Dialog
          title="Fundraising Goals for 2019"
        ...
        >
          ...
          <p>
        These funds will finance a new Garden Entry Welcome Plaza in 2019, with lush plantings, energy-efficient lighting, durable and secure fencing, hardscaped sidewalks and containers, drought-tolerant irrigation. These will set off the Gardens’ grand new wrought-iron gates, designed by local artist <a target="_blank" rel="noopener noreferrer" href="http://www.slmetalworks.com/">Shawn Lovell</a> and financed by Oakland’s Measure DD.
          </p>
          <p>
            The tradition now enters its eighth year, with a new fundraising target of $400,000 for a second phase.
          </p>
          <p>
