...
let wideHeader = (
  <Tabs className="nav-tabs">
    ...
    <Tab className="nav-tab ext-link" label="Festival Program" rel="noopener noreferrer" target="_blank" href="./ALF19_Program_3R.pdf"/>
    {
...
let iconElement = (
  <div id="icon-menu">
    ...
    >
      ...
      <MenuItem rel="noopener noreferrer" target="_blank" href="./ALF19_Program_3R.pdf" primaryText="Festival Program"></MenuItem>
    {
