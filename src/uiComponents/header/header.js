...
let wideHeader = (
  <Tabs className="nav-tabs">
    ...
    <Tab className="nav-tab" label="Tickets - On Sale Now!" rel="noopener noreferrer" target="_blank" href="https://www.eventbrite.com/e/6th-annual-autumn-lights-festival-tickets-37322323073"/>
